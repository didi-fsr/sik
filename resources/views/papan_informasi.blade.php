                        ...
                        <div class="panel panel-primary">
                            ...
                            <ul class="list-group">
                              <li class="list-group-item">
                                <h4 id="umum_head1"> Judul Pengumuman <span>-</span>
                                  <small>Paragraph Pengumuman bla bla bla bla bla</small>
                                </h4>
                              </li>
                              <li class="list-group-item">
                                <h4 id="umum_head1"> Judul Pengumuman <span>-</span>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Fitria Sekarwulan</td>
                                            </tr>
                                            <tr>
                                                <td class="info">Tingkat IV</td>
                                                <td>Puji Heliyanto</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Salam bin Salim</td>
                                                <td>Tk.IV RB-A</td>
                                                <td>dd-mm-yy,09.00</td>
                                                <td>dd-mm-yy,09.00</td>
                                                <td>Menemui Pembimbing</td>
                                            </tr>
                                            <tr>
                                                <td>Salam bin Salim</td>
                                                <td>Tk.IV RB-A</td>
